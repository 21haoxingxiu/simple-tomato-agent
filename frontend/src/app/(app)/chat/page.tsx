      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="p-4 border-t border-gray-200 bg-white">
          <div className="flex gap-3 items-center max-w-4xl mx-auto">
            ...
            {/* Buttons - vertically centered with input */}
            <div className="flex items-center gap-2 shrink-0">
              ...
              {loading ? (
                <button
                  ...
                  className="w-10 h-10 rounded-xl bg-gray-200 text-gray-700 flex items-center justify-center hover:bg-gray-300"
                  title="停止生成"
                >
                  <Square size={16} />
                </button>
                ...
                <button
                  onClick={() => handleSend()}
                  disabled={!input.trim()}
                  className="w-10 h-10 rounded-xl bg-indigo-600 text-white flex items-center justify-center hover:bg-indigo-700 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
                >
                  <Send size={18} />
                </button>
              )}
