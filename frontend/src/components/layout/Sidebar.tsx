...
import { BookOpen, MessageSquare, FlaskConical, Bot, Settings, HelpCircle } from "lucide-react"
  ...
  return (
    <aside className="w-16 lg:w-56 flex flex-col bg-gray-900 text-white shrink-0 h-full">
      ...
      <div className="p-3 border-t border-white/10 space-y-1">
        ...
        {/* User Avatar */}
        <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-white/10 cursor-pointer transition-all mt-2">
