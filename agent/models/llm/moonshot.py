...
@register_chat_provider("moonshot")
class MoonshotChatModel(BaseChatModel):
    """Moonshot (Kimi) chat model wrapper using OpenAI-compatible API."""
